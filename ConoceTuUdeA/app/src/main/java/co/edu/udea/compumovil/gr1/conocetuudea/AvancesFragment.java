...
public class AvancesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (savedInstanceState == null) {
            ...
            viewPager = (ViewPager) view.findViewById(R.id.avancesPager);
    ...
    private void poblarViewPager(ViewPager viewPager) {
        ...
        AchievementsFragment aF= new AchievementsFragment();

        adapter.addFragment(upF, getString(R.string.perfil));
        adapter.addFragment(aF, getString(R.string.logros));
